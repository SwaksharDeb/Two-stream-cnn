...
class DataGenerator(object):
    ...
    def batch_cursors(self, data_num):
        batch_output_cursors = []  # store the batch indices
...
if __name__ == '__main__':
    data = DataGenerator('F:/final thesis/stroke rehabitation/Dataset/cross_subject/cross_subject/cs_trn.hdf5',32,30)
