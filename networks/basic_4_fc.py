...
from tensorflow.keras.layers import Activation, Dropout, Flatten, concatenate, Maximum
...
use_bias = False
train_path = 'F:/final thesis/stroke rehabitation/Dataset/cross_subject/cross_subject/cs_trn.hdf5'
tst_path = 'F:/final thesis/stroke rehabitation/Dataset/cross_subject/cross_subject/cs_tst.hdf5'
# weight_path = 'F:/NTU60/weights/basic_4_fc.h5'
save_path = 'basic_4_fc_bias.h5'
graph_path = 'model_v1.png'


def share_stream(x_shape):
    x = Input(shape=x_shape)
    x_a = Transformer(d_k, frames)(x)
    #custom_layer = Transformer(d_k, frames)
    #x_a = custom_layer(x)
